...
# Database User Password Changer
#
# DESCRIPTION:
# Script to change database user passwords for PostgreSQL and MySQL
# Attempts to connect and modify passwords using default admin usernames
#
# SUPPORTED DATABASES:
# - PostgreSQL
# - MySQL
#
# FUNCTIONS:
# - psql_db_pass_change: Changes PostgreSQL database passwords
# - mysql_db_pass_change: Changes MySQL database passwords
#
# DEFAULT ADMIN USERS ATTEMPTED:
# ['root', 'wiki', 'postgres', 'administrator', 'sa', 'admin', 
#  'SA', 'Administrator', 'Admin', 'notroot']
#
# USAGE:
# Import and call functions with:
# - host: Database server IP/hostname
# - passwords: List of potential current passwords
